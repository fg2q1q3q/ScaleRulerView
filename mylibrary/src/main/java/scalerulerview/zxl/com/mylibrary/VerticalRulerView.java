...
//        canvas.drawRect(0, 0+H, mWidth, mHeight+H, mBgPaint);
        canvas.drawRect(0+H, 0, mWidth, mHeight+H, mBgPaint);
    }
    ...
    private void drawIndicator(Canvas canvas) {
        ...
        path.moveTo(0+H,mHeight / 2 - mIndicatorHalfWidth);
        path.lineTo(mIndicatorHalfWidth+H,mHeight / 2 );
        path.lineTo(0+H,mHeight / 2 + mIndicatorHalfWidth );
